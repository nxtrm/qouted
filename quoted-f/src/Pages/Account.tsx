import { Center, Divider, HStack, Heading, Image, SimpleGrid, Text, VStack, useColorModeValue, useToast } from "@chakra-ui/react";
...
function Account() {
    const { username, liked_quotes, isLoggedIn } = useUserContext();
            ...
            <VStack paddingY={25}>
                ...
                <SimpleGrid paddingLeft={100} columns={2} spacing={10} key={quote.id}>
                    ...
                    <HStack>
                        ...
                        <LikeButton liked={true} handleClick={() => console.log("clicked")}/>
                    </HStack>
                </SimpleGrid>
                ))}
            </VStack>
